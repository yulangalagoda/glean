...
- **Status:** Accepted — all three stages (registry/server/scan form/results view; SSE live progress; history browsing UI + CLI `--raw-dir` unification) implemented and validated against real data 2026-07-27, see Validation
- **Date:** 2026-07-27
