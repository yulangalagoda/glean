...
- **Status:** Accepted — Stage 1 (registry, server skeleton, scan form, results view) and Stage 2 (SSE live progress) implemented and validated against real data 2026-07-27; Stage 3 (history browsing UI, CLI `--raw-dir` unification) not yet built, see Validation
- **Date:** 2026-07-27
...
**Stage 3** (history browsing UI, the CLI-side D6 amendment unifying `--raw-dir`'s default) is not yet built.
